...
/**
 * Chroni akcje przed uruchomieniem przez niezalgoowanego uzytkownika
 * @author andrzej
 *
 */
public class AuthorizedAction implements ActionInterface {

	private ActionInterface action;
	private CurrentUserStorage current_user_storage;

	public AuthorizedAction(ActionInterface action, CurrentUserStorage current_user_storage) {
		this.action = action;
